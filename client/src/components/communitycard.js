...
const location = useLocation();
  ...
  const reqmembers = props.subThread && props.subThread.members
  ? Object.entries(props.subThread.members)
...
const isWideScreen = useMediaQuery('(min-width: 767px)');
  ...
  const stats = [
    { title: 'Members', value: props.subThread? Object.values(props.subThread.members).filter((value)=>value === true).length-1:0 },
